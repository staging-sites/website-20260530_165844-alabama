...
The following pages expand on the main **[Investigations]({{ '/investigations-ea7b1d/' | relative_url }})** page and cover its key branches in more detail.

- [Blue Book gap]({{ '/blue-book-gap/' | relative_url }})
- [Kelly response]({{ '/kelly-response/' | relative_url }})
