...
show_ads: true
description: The August-versus-September conflict shows how a small archival mismatch can change how readers track a famous state UFO case.
hero_summary: The August-versus-September conflict shows how a small archival mismatch can change how readers track a famous state UFO case.
layout: default
permalink: /date-trail/
sidebar_expanded_urls:
- /what-really-happened-in-south-dakotas/
- /white-lake/
nav_short_title: Date trail
title: Why does White Lake have two dates?
title_full: Why does White Lake have two dates?
display_title_short: Date trail
display_title: Date trail
heading_title: Why does White Lake have two dates?
page_heading_title: Why does White Lake have two dates?
source_count: 31
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How much did the skywatcher role prove?
header:
  og_image: /assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1-social.jpg
  preview_image: /assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1.webp
image: /assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1-social.jpg
---

## Introduction

One of the most confusing details in the White Lake UFO file is also one of the smallest: the date. Some accounts place the sighting on 14 September 1952, while others give 14 August 1952. For readers trying to follow the history of one of South Dakota’s best-known Project [Blue Book]({{ 'blue-book-eb3f6b/' | relative_url }}) cases, that difference matters more than it first appears.

<img src="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1-dark.svg" | relative_url }}" alt="Date trail illustration 1" data-theme-src-dark="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-1-light.svg" | relative_url }}" loading="eager" decoding="sync" fetchpriority="high">
...
<img src="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-3-dark.svg" | relative_url }}" alt="Date trail illustration 3" data-theme-src-dark="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/South_Dakota_ad4a41_white_lake_unidentif_bfc7fb_white_lake_date_trai_4eafdc-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to handle conflicting UFO sources
