...
child_basenames:
- Massachusetts_d42990_muddy_river_1639_lig_898157_index
...
show_ads: true
description: The Muddy River account is historically fascinating, but it works better as an early strange-light story than as modern UFO evidence.
hero_summary: The Muddy River account is historically fascinating, but it works better as an early strange-light story than as modern UFO evidence.
layout: default
...
page_heading_title: Was America's First UFO Really in Boston?
source_count: 40
infographic_count: 3
planned_sections:
- What Winthrop's journal describes
- Why colonial context changes the question
- Natural light explanations and later retellings
...
next_link:
  ...
  heading_title: Why the Salem UFO Photo Still Divides Readers
header:
  og_image: /assets/images/Massachusetts_d42990_muddy_river_1639_lig_898157-overview-social.jpg
  preview_image: /assets/images/Massachusetts_d42990_muddy_river_1639_lig_898157-overview.webp
image: /assets/images/Massachusetts_d42990_muddy_river_1639_lig_898157-overview-social.jpg
---
...
Modern analyses stress that this account lacks the kinds of precise observational data, independent corroboration, or physical evidence that investigators today would require to substantiate claims of aircraft or unexplained vehicles. Instead, scholars of folklore and natural phenomena point to explanations such as **ignis fatuus** (also called will‑o’‑the‑wisp) — luminescent emissions often seen over marshy or swampy ground due to spontaneously igniting gases like methane — to explain stray lights in low‑technology eras. Although ignis fatuus typically appears close to ground and is brief, historical descriptions show that light phenomena could be variable and surprising.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Will-o%27-the-wisp" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-snippet">Open source on wikipedia.org.</span></span></span>
...
<p class="fr-intro">Books and field guides related to Was America&#x27;s First UFO Really in Boston?. Use these as the next step if you want deeper reading beyond the article.</p>
</div>
...
<p class="fr-book-desc">Offers a framework for evaluating unusual reports across eras.</p>
...
<p class="fr-book-desc">Directly relevant to interpreting pre-modern strange-light accounts.</p>
<div class="fr-book-actions">
