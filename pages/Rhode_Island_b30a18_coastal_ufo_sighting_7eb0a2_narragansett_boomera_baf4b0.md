...
show_ads: true
description: A dramatic 2009 beach sighting shows how one changing distance estimate can turn lights over water into a huge fast-moving craft.
hero_summary: A dramatic 2009 beach sighting shows how one changing distance estimate can turn lights over water into a huge fast-moving craft.
layout: default
...
page_heading_title: Did the Narragansett boomerang really rush overhead?
source_count: 26
infographic_count: 3
planned_sections:
- What the witness reported from Narragansett Beach
- Why range, scale and speed are hard to fix
...
next_link:
  ...
  heading_title: When harbour lights look like UFOs
header:
  og_image: /assets/images/Rhode_Island_b30a18_coastal_ufo_sighting_7eb0a2_narragansett_boomera_baf4b0-Illustration-1-social.jpg
  preview_image: /assets/images/Rhode_Island_b30a18_coastal_ufo_sighting_7eb0a2_narragansett_boomera_baf4b0-Illustration-1.webp
image: /assets/images/Rhode_Island_b30a18_coastal_ufo_sighting_7eb0a2_narragansett_boomera_baf4b0-Illustration-1-social.jpg
---
...
* A distinctive boomerang or chevron-like shape rather than a simple point of light.
* Multiple coloured lights reported as part of a single object.
* An apparent approach from offshore towards the beach.
* A sudden directional change.
* An estimated size far larger than a conventional aircraft if the distance estimate was accurate.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://nuforc.org/sighting/?id=69370" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nuforc.org">[NUFORC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nuforc.org</span><span class="citation-popover-snippet">NUFORC UFO Sighting 69370NUFORC UFO Sighting 69370; Occurred: 2009-03-23 20:00 Local; Reported: 2009-03-24 19:37 Pacific; Duration: 30...</span><span class="citation-popover-meta">Published: March 23, 2009</span></span></span>

</div>

Those details sound less like a distant light and more like a structured craft. The problem is that nearly every extraordinary element depends on the witness correctly judging range across open water.

## Why range, scale and speed are hard to fix

The Narragansett report illustrates a common weakness in coastal UFO cases: the witness knows what the object looked like but has little reliable information about how far away it was.

Across a dark ocean horizon there are few visual references. A light can appear low above the water without revealing whether it is hundreds of metres away or several miles distant. Aircraft approaching on a direct path can seem stationary before suddenly appearing larger. Several lights can visually merge into a single shape. The observer's brain fills in missing depth information using assumptions that may be wrong.

In the Narragansett case, the witness first described the object as appearing “many miles offshore”. That estimate was not based on radar, navigation data, triangulation or known landmarks. It was an impression. If that impression was mistaken, every later estimate changes as well.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://nuforc.org/sighting/?id=120688" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nuforc.org">[NUFORC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nuforc.org</span><span class="citation-popover-snippet">NUFORC UFO Sighting 120688Red and blue light UFO over Cranston, Rhode Island, landing vertically in Narragansett Bay.... green lights yo...</span></span></span>
...
1. The object is assumed to be many miles away.
2. It appears relatively small.
3. It then appears much larger overhead.
4. Therefore it must have crossed a huge distance extremely quickly.

</div>

The conclusion depends on step one being correct. If the object was actually much closer than believed, the apparent speed drops sharply. A nearby object can seem to “grow” dramatically in size because its angular size changes rapidly as it approaches. A distant object cannot produce the same visual effect without covering far greater ground.

This is one reason aviation investigators and accident analysts are cautious about eyewitness speed estimates. Human observers are generally better at describing what they saw than at calculating range, altitude or velocity without external references.

## The overlooked problem with the 100-yard estimate

The reported size estimate of roughly 100 yards wide is often repeated because it sounds extraordinary. Yet that figure is arguably the least secure part of the entire sighting.

An observer cannot directly measure the width of an unknown object in the sky. The estimate comes from combining two uncertain impressions:

* How large the object appeared visually.
* How far away the observer believed it was.

If either value is wrong, the final size estimate changes dramatically.

For example, an object thought to be hundreds of metres away may be interpreted as enormous. The same apparent visual size at a much shorter distance would imply a much smaller object. The witness may have been entirely sincere while still making an incorrect calculation.
...
Witnesses often describe lights as moving directly above them when the object is actually travelling at some distance. At night, without visible terrain markers, a light crossing part of the sky can seem much closer than it is.
...
* Apparent hovering while moving towards the observer.
* Sudden growth in brightness.
* Rapid expansion in apparent size.
* A perceived turn or pivot as viewing angle changes.
* A feeling that the object passed overhead when it actually crossed some distance away.
...
The Narragansett report remains intriguing because it contains than many brief UFO submissions. However, the evidence needed to confirm the witness's interpretation is largely absent.

The case would be considerably stronger if it had included:

<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Independent witnesses at a second location who reported the same object.
* Photographs or video with identifiable landmarks.
* Precise timing and compass bearings.
* Weather and visibility records linked to the sighting.
* Flight-tracking information excluding nearby aircraft.
* Marine traffic records excluding vessels in the viewing direction.
* Radar confirmation showing an object matching the reported movement.
...
* Aircraft traffic matching the direction and timing.
* Evidence that the object remained near the horizon rather than overhead.
* Conflicting witness estimates of location.
* Demonstrations that the lights could be produced by known aircraft configurations.
* Confirmation of marine traffic in the viewing corridor between Narragansett and the offshore horizon.
...
The Narragansett boomerang report is valuable less because it proves an extraordinary craft and more because it exposes a recurring problem in Rhode Island's coastal UFO record. Many shoreline sightings begin with a confident statement about distance: a light is said to be hovering offshore, pacing a vessel, approaching from the ocean or hanging over the bay. Yet the water itself often removes the visual clues needed to make those judgements reliably.
...
<p class="fr-intro">Books and field guides related to Did the Narragansett boomerang really rush overhead?. Use these as the next step if you want deeper reading beyond the article.</p>
</div>
...
<p class="fr-book-desc">Highlights cases where trained observers reported unusual objects.</p>
...
<p class="fr-book-desc">Directly relevant to witness estimates of size, speed and distance.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Encourages scrutiny of dramatic claims arising from uncertain observations.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Examines recurring unusual-object narratives.</p>
<div class="fr-book-actions">
