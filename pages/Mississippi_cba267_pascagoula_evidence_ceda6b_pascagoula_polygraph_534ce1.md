...
page_heading_title: Did the polygraphs really settle Pascagoula?
source_count: 49
infographic_count: 3
planned_sections:
- What was claimed about Hickson and Parker's tests
- Why polygraphs measure stress, not event truth
...
prev_link:
  ...
  heading_title: What did the hidden police tape prove?
header:
  og_image: /assets/images/Mississippi_cba267_pascagoula_evidence_ceda6b_pascagoula_polygraph_534ce1-Illustration-1-social.jpg
  preview_image: /assets/images/Mississippi_cba267_pascagoula_evidence_ceda6b_pascagoula_polygraph_534ce1-Illustration-1.webp
image: /assets/images/Mississippi_cba267_pascagoula_evidence_ceda6b_pascagoula_polygraph_534ce1-Illustration-1-social.jpg
---
...
* The men reported the incident immediately.
* Police officers said they appeared frightened.
* Secretly recorded conversations suggested genuine distress.
* Polygraph examiners reportedly judged them truthful.
...
* Frightened.
* Embarrassed.
* Traumaticly affected by an experience.
* Worried about being disbelieved.
* Anxious about the examination itself.

</div>

None of those reactions automatically mean the person is lying. Equally, a calm or practised deceiver may not show the expected responses. This creates the possibility of both false positives and false negatives. FAS Project on Government Secrecy <span class="citation-chip-wrap"><a class="citation-chip" href="https://pmc.ncbi.nlm.nih.gov/articles/PMC6654171/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: pmc.ncbi.nlm.nih.gov">[PMC]</a><span class="citation-popover" role="note"><span class="citation-popover-source">pmc.ncbi.nlm.nih.gov</span><span class="citation-popover-title">PMCDeception Detection and the Autonomic Nervous System</span><span class="citation-popover-snippet">Detection and the Autonomic Nervous System - PMCby LG Cook · 2019 · Cited by 39 — By using vital signs as an indirect measurement of dece...</span></span></span>
...
* An actual external event.

</div>

It can only assess physiological reactions during questioning. <span class="citation-chip-wrap"><a class="citation-chip" href="https://jaapl.org/content/38/4/446" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: jaapl.org">[J Am Acad Psychiatry Law]</a><span class="citation-popover" role="note"><span class="citation-popover-source">jaapl.org</span><span class="citation-popover-snippet">J Am Acad Psychiatry LawThe Polygraph and Forensic PsychiatryThe polygraph is commonly referred to as a lie detector, but it does not rec...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://issues.org/faigman-polygraph-lie-detector-limits-accuracy/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: issues.org">[Issues]</a><span class="citation-popover" role="note"><span class="citation-popover-source">issues.org</span><span class="citation-popover-snippet">Issues in Science and TechnologyThe Limits of the PolygraphPolygraph tests are used to detect lies, but how accurate are they? This analy...</span></span></span> in Science and Technology
...
If a case depends heavily on personal testimony, then evidence of sincerity becomes valuable. The hidden police recording and the reported polygraph results both point in that direction. They suggest the men were not casually inventing a story for amusement immediately after arriving at the sheriff's office. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.washingtonpost.com/history/2019/06/26/i-floated-inside-man-returns-site-ufo-abduction-it-gets-historical-marker/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: washingtonpost.com">[The Washington Post]</a><span class="citation-popover" role="note"><span class="citation-popover-source">washingtonpost.com</span><span class="citation-popover-title">i floated inside man returns site ufo abduction it gets historical marker</span><span class="citation-popover-snippet">The Washington PostThe men claimed they were abducted by aliens. In...26 Jun 2019 — Each had a puncture wound in one arm. Police tried t...</span></span></span>

However, sincerity is not the same as verification.

A useful comparison is eyewitness testimony after a traumatic accident. A witness may be completely honest yet still misremember timings, distances or details. Courts, investigators and psychologists recognise this problem regularly. The same caution applies to extraordinary UFO claims. A polygraph may strengthen an argument that witnesses believed their account, but it does not independently confirm that non-human beings examined them inside a craft. <span class="citation-chip-wrap"><a class="citation-chip" href="https://jaapl.org/content/38/4/446" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: jaapl.org">[J Am Acad Psychiatry Law]</a><span class="citation-popover" role="note"><span class="citation-popover-source">jaapl.org</span><span class="citation-popover-snippet">J Am Acad Psychiatry LawThe Polygraph and Forensic PsychiatryThe polygraph is commonly referred to as a lie detector, but it does not rec...</span></span></span> <span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.nationalacademies.org/read/10420/chapter/2" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nationalacademies.org">[National Academies]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nationalacademies.org</span><span class="citation-popover-snippet">National AcademiesThe Polygraph and Lie Detection (2003)The general quality of the evidence for judging polygraph validity is relatively...</span></span></span>
...
Sceptical writers generally do not argue that the polygraph results prove the witnesses were lying. Instead, they argue that believers ask the tests to do more than they are capable of doing.

One sceptical line of argument is methodological. Critics note that polygraph accuracy remains disputed and that test outcomes can depend on examiner skill, question design and interpretation. Some critics of the Pascagoula case specifically questioned the quality or significance of the examinations themselves. <span class="citation-chip-wrap"><a class="citation-chip" href="https://cdn.centerforinquiry.org/wp-content/uploads/sites/29/2012/05/22164303/p12.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: cdn.centerforinquiry.org">[cdn.centerforinquiry.org]</a><span class="citation-popover" role="note"><span class="citation-popover-source">cdn.centerforinquiry.org</span><span class="citation-popover-snippet">“inexperienced” polygraph operator and that Hickson refused to take another administered by an expert police exam...Read more...</span></span></span>

A second sceptical argument focuses on category error. Even a perfectly administered polygraph could only suggest whether a subject appeared deceptive during questioning. It could not establish that an extraordinary claim was objectively true. In this view, passing a polygraph is compatible with genuine belief, mistaken perception or inaccurate memory. <span class="citation-chip-wrap"><a class="citation-chip" href="https://jaapl.org/content/38/4/446" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: jaapl.org">[J Am Acad Psychiatry Law]</a><span class="citation-popover" role="note"><span class="citation-popover-source">jaapl.org</span><span class="citation-popover-snippet">J Am Acad Psychiatry LawThe Polygraph and Forensic PsychiatryThe polygraph is commonly referred to as a lie detector, but it does not rec...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://committees.parliament.uk/writtenevidence/7506/html/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: committees.parliament.uk">[UK Parliament Committees]</a><span class="citation-popover" role="note"><span class="citation-popover-source">committees.parliament.uk</span><span class="citation-popover-snippet">UK Parliament CommitteesExecutive Summary22 Jun 2020 — Polygraph operators face thus an unpalatable dilemma: Either to inform the subject...</span></span></span>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Did the polygraphs really settle Pascagoula?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    <div class="fr-books-grid">

    <article class="fr-book-card">
      <a class="fr-book-cover fr-book-cover-placeholder" href="https://www.amazon.com/s?k=The+Worlds+of+the+early+Greek+philosophers+Wilbur%2C+James+Benjamin&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Worlds of the early Greek philosophers on Amazon"><span class="fr-book-cover-fallback">Book</span></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=The+Worlds+of+the+early+Greek+philosophers+Wilbur%2C+James+Benjamin&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Worlds of the early Greek philosophers">The Worlds of the early Greek philosophers</a>
        </h4>
        <p class="fr-book-author">By Wilbur, James Benjamin</p>
        
        <p class="fr-book-desc">Useful for understanding evidence standards beyond witness testing.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=The+Worlds+of+the+early+Greek+philosophers+Wilbur%2C+James+Benjamin&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers the witness perspective on credibility and investigation.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages critical analysis of extraordinary claims and evidence.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Documents the original claims behind the polygraph debate.</p>
        <div class="fr-book-actions">
    ...
    <div class="fr-section-footer">
      <div class="fr-browse-links" aria-label="Browse more on Amazon"><span class="fr-browse-links-label">Browse more on Amazon:</span> <a class="fr-browse-more" href="https://www.amazon.com/s?k=The+Worlds+of+the+early+Greek+philosophers&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">The Worlds of the early Greek philosophers</a> <a class="fr-browse-more" href="https://www.amazon.com/s?k=Pascagoula+The+Closest+Encounter&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">Pascagoula The Closest Encounter</a> <a class="fr-browse-more" href="https://www.amazon.com/s?k=The+Demon+Haunted+World&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">The Demon Haunted World</a></div>
