...
child_basenames:
- Tennessee_1f4d4c_modern_report_patter_1bec66_index
...
show_ads: true
description: Modern Tennessee UFO reporting is rich in volume but uneven in quality, from city sightings to rural dark-sky reports.
hero_summary: Modern Tennessee UFO reporting is rich in volume but uneven in quality, from city sightings to rural dark-sky reports.
layout: default
...
page_heading_title: Where Do Tennesseans Report UFOs Most?
source_count: 120
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Why Did Oak Ridge Draw UFO Attention?
header:
  og_image: /assets/images/Tennessee_1f4d4c_modern_report_patter_1bec66-overview-social.jpg
  preview_image: /assets/images/Tennessee_1f4d4c_modern_report_patter_1bec66-overview.webp
image: /assets/images/Tennessee_1f4d4c_modern_report_patter_1bec66-overview-social.jpg
---
...
1. **Can the object be checked against common sky events?** Starlink, the International Space Station, bright planets, meteors, aircraft routes and drone activity should be considered first.
2. **Is the report independent or copied?** Multiple witnesses matter most when they are separated, not merely repeating the same social media post.
3. **Is there instrument data?** A steady video, radar record, ADS-B flight data, weather record or astronomical check is more useful than memory alone.
4. **Does the report include enough geometry?** Direction, elevation and duration make ordinary explanations easier to test.
5. **Has the source already flagged an explanation?** NUFORC’s “Meteor - Certain” or “Starlink?” notes should not be ignored.
